...
export function Header({ status }: HeaderProps) {
  return (
    <header className="fixed z-50 text-gray-800 flex items-center w-full px-4 border-b-[0.75px] sm:border-b-[0.5px] border-gray-300 bg-gray-50/90 backdrop-blur-md lg:px-6 h-14 shadow-sm">
      ...
      <nav className="flex items-center gap-4 ml-auto">
        ...
        <div className="flex items-center gap-3 ml-2">
          ...
          <Link
            className="inline-flex items-center justify-center p-2 text-sm font-medium transition-colors bg-gray-900 shadow aspect-square rounded-xl squircle h-9 text-gray-50 hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50"
          ...
          <Link
            className="inline-flex items-center justify-center p-2 aspect-square text-sm font-medium transition-colors bg-[#5865F2] rounded-xl squircle shadow h-9 text-gray-50 hover:bg-[#4053D6] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50"
